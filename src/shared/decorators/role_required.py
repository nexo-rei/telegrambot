...
BUG FIX: This decorator's implementation was accidentally placed inside
`src/shared/event_bus/__init__.py` instead of this file. That caused:
  1. Importing `from src.shared.event_bus import EventBus` to fail (EventBus was absent)
  2. This file was empty/missing its implementation

Moved the implementation here where it belongs.
"""
